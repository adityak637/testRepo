        ...
        serviceMethod()
                    ...
                    */
                    if (actionTypeFailure instanceof Array) {
                        actionTypeFailure.forEach((value) => {
                            dispatch({
                                type: value,
                                error: responseJson.code ? responseJson.code : '', // Returns error code if exist otherwise returns empty string
            ...
            .catch((error) => {
                ...
                */
                ...
                dispatch({
                    type: actionTypeFailure,
                    error: err.code ? err.code : '', // Returns error code if exist otherwise returns empty string
